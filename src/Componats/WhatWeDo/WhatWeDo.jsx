  ...
  return (
    <div className='md:py-14 py-12 '>
        <div className='md:w-7xl  px-4 md:px-0 mx-auto'>
            <div>
                <h3 className='md:text-center md:text-4xl text-3xl font-bold mb-12 gap-5'>What We Do</h3>
            </div>
            <div className='grid md:grid-cols-4 grid-cols-1  '>
                ...
                <div className='col-span-2'>
                    <picture>
                        <img className='md:w-full md:h-auto object-cover md:col-span-1' src={Buldozar}/>
                    </picture>
                </div>
                 {/* work card 4........... */}
